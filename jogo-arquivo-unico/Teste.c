...
void jogoMultiplayer() {
    ...
    char resultado[20];
    int partidaMelhor3 = 3;
    int partidaMelhor5 = 5;
    char jogador[10];
...
/*
    int escolherTipoPartida() {
        int opcao;
        do {
            printf("\nEscolha o tipo de partida:\n");
            printf("1 - Melhor de 3\n");
...
void iniciarJogo() {
    ...
    do {
        ...
        switch(opcao) {
            ...
            case 1:
                system("cls");
                jogoMultiplayer(/*partidaMelhorde5, partidaMelhorde3*/);
                break;
